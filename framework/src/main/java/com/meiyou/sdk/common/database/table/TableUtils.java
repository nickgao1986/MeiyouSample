...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, Id> entityIdMap = new ConcurrentHashMap<String, com.meiyou.sdk.common.database.table.Id>();
...
//        return id;
    ...
    public static List<Column> getUnique(Class<?> entityType) {
        com.meiyou.sdk.common.database.table.Table table =
                com.meiyou.sdk.common.database.table.Table.get(entityType);
