 ...
 * Time: 上午9:35
 */
public class WithArgsWhereBuilder {

    private final List<String> whereItems;

    private WithArgsWhereBuilder() {
     ...
     * @return
     */
    public static WithArgsWhereBuilder b() {
        return new WithArgsWhereBuilder();
    }
     ...
     * @return
     */
    public static WithArgsWhereBuilder b(String columnName, String op, Object value) {
        WithArgsWhereBuilder result = new WithArgsWhereBuilder();
     ...
     * @return
     */
    public WithArgsWhereBuilder and(String columnName, String op, Object value) {
     ...
     * @return
     */
    public WithArgsWhereBuilder or(String columnName, String op, Object value) {
        appendCondition(whereItems.size() == 0 ? null : "OR", columnName, op, value);
        return this;
    }

    public WithArgsWhereBuilder expr(String expr) {
        whereItems.add(" " + expr);
        return this;
    }

    public WithArgsWhereBuilder expr(String columnName, String op, Object value) {
