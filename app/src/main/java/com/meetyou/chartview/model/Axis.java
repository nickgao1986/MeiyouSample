...
import com.meetyou.chartview.formatter.AxisValueFormatter;
import com.meetyou.chartview.formatter.SimpleAxisValueFormatter;
...
public class Axis {
     ...
     * Axis grid lines color.
     */
    private int separateLineColor = ChartUtils.COLOR_BLACK_E;
    ...
    private boolean hasXLabels = true;

    private boolean hasYLabels = true;

    // 是否有封闭线
    private boolean hasEndLine = true;
    ...
    public Axis setSeparateLineColor(int separateLineColor) {
    ...
    public Axis setHasXLabels(boolean hasXLabels) {
        this.hasXLabels = hasXLabels;
        return this;
    }

    public boolean hasYLabels() {
        return hasYLabels;
    }

    public Axis setHasYLabels(boolean hasYLabels) {
        this.hasYLabels = hasYLabels;
        return this;
    }
