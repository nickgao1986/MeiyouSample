...
public class ShowImageLoadingLayout extends LoadingLayout {
    ...
    public ShowImageLoadingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = ViewFactory.from(context).getLayoutInflater().inflate(R.layout.loadinglayout_show_iamge, this);
