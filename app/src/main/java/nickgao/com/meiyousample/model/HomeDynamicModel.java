...
//        JSONArray commentArray = StringUtils.getJsonArray(jsonObject, "recommon");
//        if (null != commentArray && commentArray.length() > 0) {
//            dynamicCommentModelList = new ArrayList<DynamicCommentModel>();
//            for (int i = 0; i < commentArray.length(); i++) {
//                try {
//                    DynamicCommentModel dynamicCommentModel = new DynamicCommentModel(commentArray.getJSONObject(i));
//                    dynamicCommentModelList.add(dynamicCommentModel);
