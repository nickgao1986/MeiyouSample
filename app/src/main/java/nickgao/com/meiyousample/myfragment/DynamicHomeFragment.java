 ...
 * 密友圈
 */
public class DynamicHomeFragment extends PeriodBaseFragment implements OnClickListener,PersonalListener {
    ...
    public static Intent getNotifyIntent(Context context) {
        Intent intent = new Intent(context, DynamicHomeFragment.class);
...
//        taskLoadDynamic.execute();
    ...
    private void initTitle() {
        ...
        ImageView custom_iv_left = (ImageView)rootView.findViewById(R.id.custom_iv_left);
        rl_custom_title_bar = (RelativeLayout)rootView.findViewById(R.id.rl_custom_title_bar);
        rl_custom_title_bar.setAlpha(0);
        TextView tv_publish_dynamic = (TextView)rootView.findViewById(R.id.tv_publish_dynamic);
...
//                handlePublishDynamic();
    ...
    private void initUI() {
        ...
        rootContainer = (ResizeLayout) rootView.findViewById(R.id.rootContainer);
        parallaxListview = (ParallaxScrollListView) rootView.findViewById(R.id.home_list);

        llTopMenu = (LinearLayout) rootView.findViewById(R.id.linearMsgTopMenu);
