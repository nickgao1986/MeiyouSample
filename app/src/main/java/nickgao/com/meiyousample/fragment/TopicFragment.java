...
public class TopicFragment extends PersonalContentFragment implements TopicListener {
    ...
    private void initView() {
        mAdapter = new MyPersonalTopicListAdapter(mActivity, models, MyPersonalTopicListAdapter.TopicType.TYPE_PUBLISH,mListview);
