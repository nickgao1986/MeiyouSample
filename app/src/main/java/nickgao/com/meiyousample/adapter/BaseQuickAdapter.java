...
/**
 * BaseQuickAdapter的简化版,只支持最基本的功能.
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        this.mLayoutInflater = ViewFactory.from(mContext).getLayoutInflater();
        switch (viewType) {
            case HEADER_VIEW:
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    if (mSpanSizeLookup == null)
                        return (type == EMPTY_VIEW || type == HEADER_VIEW || type == FOOTER_VIEW) ? gridManager.getSpanCount() : 1;
                    else
                        return (type == EMPTY_VIEW || type == HEADER_VIEW || type == FOOTER_VIEW) ? gridManager.getSpanCount() : mSpanSizeLookup.getSpanSize(gridManager,
    ...
    public void setEmptyView(int layoutResId, ViewGroup viewGroup) {
        View view = ViewFactory.from(viewGroup.getContext()).getLayoutInflater().inflate(layoutResId, viewGroup, false);
        setEmptyView(view);
    }
