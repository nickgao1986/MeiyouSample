...
import com.meiyou.media.player.tv.IjkLibLoader;
...
/**
 * Linhonghong:这个类是从BBC大大那边拿过来的部分sample代码,
 * 参考Android原生的Mediaplayer写法构造,
 * 这里使用抽象播放器处理媒体流数据
...
//                DebugLog.d("player_buffer",bufferPosition + "k");
//                if (bufferPosition < 0) {
//                    bufferPosition = 0;
//                }
//
